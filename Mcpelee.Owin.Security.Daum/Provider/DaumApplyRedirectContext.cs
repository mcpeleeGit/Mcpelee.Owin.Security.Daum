...
{
    /// <summary>
    /// Context passed when a Challenge causes a redirect to authorize endpoint in the Daum middleware
    /// </summary>
    public class DaumApplyRedirectContext : BaseContext<DaumAuthenticationOptions>
    {
        /// <summary>
        /// Creates a new context object.
        /// </summary>
        /// <param name="context">The OWIN request context</param>
        /// <param name="options">The Daum middleware options</param>
        ...
        public DaumApplyRedirectContext(IOwinContext context, DaumAuthenticationOptions options,
